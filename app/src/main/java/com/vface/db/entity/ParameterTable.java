...
public class ParameterTable extends TableInfo {
	...
	private static void Initial() {
		...
		_current.Add(C_ParamKey, new ColumnInfo(C_ParamKey, "ParamKey", true,
				"String"));
		_current.Add(C_ParamValue, new ColumnInfo(C_ParamValue, "ParamValue",
				false, "String"));
		_current.Add(C_UpdateTime, new ColumnInfo(C_UpdateTime, "UpdateTime",
				false, "String"));
		_current.Add(C_UserId, new ColumnInfo(C_UserId, "UserId", false,
				"Integer"));
	}
