...
import com.vface.db.ColumnInfo;
import com.vface.db.TableInfo;
...
public class ConfigTable extends TableInfo {
	...
	private static void Initial() {
		...
		_current.Add(C_Userid, new ColumnInfo(C_Userid, "Userid", true,
				"Integer"));
		_current.Add(C_Language, new ColumnInfo(C_Language, "Language", false,
				"String"));
		_current.Add(C_AllowPush, new ColumnInfo(C_AllowPush, "AllowPush",
				false, "Integer"));
		_current.Add(C_Privacy, new ColumnInfo(C_Privacy, "Privacy", false,
				"String"));
		_current.Add(C_Currentversion, new ColumnInfo(C_Currentversion,
				"Currentversion", false, "String"));
		_current.Add(C_CachePath, new ColumnInfo(C_CachePath, "CachePath",
				false, "String"));
		_current.Add(C_UpdateTime, new ColumnInfo(C_UpdateTime, "UpdateTime",
				false, "Integer"));
	}
