...
public class ChooseItemDialog extends Dialog implements
	...
	public ChooseItemDialog(Context context, String item1Text,
			String item2Text, int whichItem, ChooseItemDialogCallBack callBack) {
	...
	public ChooseItemDialog(Context context, String item1Text,
			String item2Text, int whichItem, boolean ifShowSign,
			ChooseItemDialogCallBack callBack) {
		super(context, R.style.LoadingDialog);
		this.context = context;
		this.callBack = callBack;
		this.whichItem = whichItem;
	...
	private void init(String item1Text, String item2Text) {
		...
		RelativeLayout item1 = (RelativeLayout) dialogView
				.findViewById(R.id.item1);
		RelativeLayout item2 = (RelativeLayout) dialogView
				.findViewById(R.id.item2);

		TextView item1TextView = (TextView) dialogView
				.findViewById(R.id.txt_item1);
		TextView item2TextView = (TextView) dialogView
				.findViewById(R.id.txt_item2);
		TextView cancelTextView = (TextView) dialogView
				.findViewById(R.id.cancel_btn);
		item1SelectedSign = (ImageView) dialogView
				.findViewById(R.id.item1_selected_sign);
		item2SelectedSign = (ImageView) dialogView
				.findViewById(R.id.item2_selected_sign);
