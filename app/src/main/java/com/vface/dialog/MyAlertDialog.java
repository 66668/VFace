...
public class MyAlertDialog extends Dialog implements
	...
	public MyAlertDialog(Activity context, String title,
			MyAlertDialogCallBack callBack) {
	...
	public MyAlertDialog(Activity context, String title, String confirmText,
			MyAlertDialogCallBack callBack) {
		super(context, R.style.LoadingDialog);
		this.context = context;
		this.callBack = callBack;
	...
	private void init(String title, String confirmText) {
		...
		View dialogView = LayoutInflater.from(context).inflate(
				R.layout.dialog_confirm_without_cancel, null);

		TextView titleView = (TextView) dialogView
				.findViewById(R.id.dialog_title);
		TextView confirmTextView = (TextView) dialogView
