...
import com.vface.dialog.MyAlertDialog.MyAlertDialogCallBack;
...
//				.setMessage(message).create().show();
		MyAlertDialog dialog = new MyAlertDialog(context, message, new MyAlertDialogCallBack(){
...
//				.setMessage(context.getString(resId)).create().show();
		...
		MyAlertDialog dialog = new MyAlertDialog(context, context.getString(resId), new MyAlertDialogCallBack(){
