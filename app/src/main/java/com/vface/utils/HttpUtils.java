...
import com.vface.R;
import com.vface.common.DeviceErrorException;
...
public class HttpUtils {
    ...
    public JSONObject postString(final String url,
                                 final HashMap<String, Object> formData) throws MyException {
     ...
     * @throws DeviceErrorException
     */
    public JSONObject postString(String url, HashMap<String, Object> formData,
                                 boolean withLogin) throws MyException {
        if (formData == null) {
     ...
     * @throws MyException
     */
    protected JSONObject postStringData(final String url,
                                        final HashMap<String, Object> formData) throws MyHttpException {
